...
const Banner = () => {
    return (
        ...
        <div className=" position-relative" >
            ...
            <div className="position-absolute  bottom-0 start-0  translate-start" style={{paddingLeft:'200px', paddingBottom:'80px'}}>
            {/* <div className="position-absolute   bottom-0 start-0 top-0  px-md-5 py-5 mx-md-5  translate-start" > */}
